...
export function FormWrapper({ children, pageType }) {
  ...
  return (
    <div className="relative min-h-120 z-3 flex-1 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      {/* Decorative Elements */}
